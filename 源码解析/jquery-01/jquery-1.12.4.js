...
;(function(global, factory) {
  ...
  // 数组的方法（slice） example： arr.slice(1) -> 删除第一个元素
  var slice = deletedIds.slice
  // 数组方法（concat）example: arr1.concat(arr2)
  var concat = deletedIds.concat
  // 数组方法 example：arr1.push(ele)
  var push = deletedIds.push
  // arr1.indexOf(ele) === 1 -> 判断ele元素在arr1中是否存在
  ...
  /**
   * @description 判断值在对象中是否存在
   * obj.hasOwnProperty('ele')
   *
   */
  ...
  /**
   * jQuqey.fn 与 jQuery.prototype 相同
   *
   */
